...
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {SEV_SEG_DATA[7]}]					
set_property PACKAGE_PIN W6 [get_ports {SEV_SEG_DATA[6]}]					
set_property PACKAGE_PIN U8 [get_ports {SEV_SEG_DATA[5]}]					
set_property PACKAGE_PIN V8 [get_ports {SEV_SEG_DATA[4]}]					
set_property PACKAGE_PIN U5 [get_ports {SEV_SEG_DATA[3]}]					
set_property PACKAGE_PIN V5 [get_ports {SEV_SEG_DATA[2]}]					
set_property PACKAGE_PIN U7 [get_ports {SEV_SEG_DATA[1]}]					
#set_property PACKAGE_PIN V7 [get_ports dp]							
set_property PACKAGE_PIN U2 [get_ports {SEV_SEG_CTRL[1]}]					
set_property PACKAGE_PIN U4 [get_ports {SEV_SEG_CTRL[2]}]					
set_property PACKAGE_PIN V4 [get_ports {SEV_SEG_CTRL[3]}]					
set_property PACKAGE_PIN W4 [get_ports {SEV_SEG_CTRL[4]}]					
